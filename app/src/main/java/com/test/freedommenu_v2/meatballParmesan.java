...
public class meatballParmesan extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meatball_parm);  //set layout
    ...
    public void OnClickButtonListener1() {
        button = (Button) findViewById(R.id.homeButtonMeatballParm);
    ...
    public void OnClickButtonListener2() {
        button = (Button) findViewById(R.id.arrowLeftMeatballParm);
        button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
    ...
    public void OnClickButtonListener3() {
        button = (Button) findViewById(R.id.arrowRightMeatballParm);
        button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
    ...
    public void OnClickButtonListener4() {
        button = (Button) findViewById(R.id.ingredientsMeatballParm);
        button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent("com.test.freedommenu_v2.ingredientsMeatballParmesan");
                        startActivity(intent);
                    }
