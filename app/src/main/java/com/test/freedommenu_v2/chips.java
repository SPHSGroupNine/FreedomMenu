...
public class chips extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chips);  //set layout
    ...
    public void OnClickButtonListener1() {
        button = (Button) findViewById(R.id.homeButtonChips);
    ...
    public void OnClickButtonListener2() {
        button = (Button) findViewById(R.id.arrowLeftChips);
        button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
    ...
    public void OnClickButtonListener3() {
        button = (Button) findViewById(R.id.arrowRightChips);
        button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
    ...
    public void OnClickButtonListener4() {
        button = (Button) findViewById(R.id.ingredientsChips);
        button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent("com.test.freedommenu_v2.ingredientsChips");
                        startActivity(intent);
                    }
