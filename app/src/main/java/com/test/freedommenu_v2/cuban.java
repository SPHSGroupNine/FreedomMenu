...
public class cuban extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cuban);  //set layout
    ...
    public void OnClickButtonListener1() {
        button = (Button) findViewById(R.id.homeButtonCuban);
    ...
    public void OnClickButtonListener2() {
        button = (Button) findViewById(R.id.arrowLeftCuban);
        button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
    ...
    public void OnClickButtonListener3() {
        button = (Button) findViewById(R.id.arrowRightCuban);
        button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
    ...
    public void OnClickButtonListener4() {
        button = (Button) findViewById(R.id.ingredientsCuban);
        button.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent("com.test.freedommenu_v2.ingredientsCuban");
                        startActivity(intent);
                    }
